...
import os
from training_and_testing.lit_dataset import inD_RecordingDataset
...
class inD_RecordingModule(pl.LightningDataModule):
    ...
    def __init__(self, data_path, recording_id,
                 sequence_length, past_sequence_length, future_sequence_length, features, batch_size: int = 32):
        super().__init__()
