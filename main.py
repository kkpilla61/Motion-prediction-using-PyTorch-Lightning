...
# For an overview on how this folder is structured, see the slides on Chapter 4 in OLAT!
...
from nn_modules import MLPModel, ConstantVelocity
...
# TODO: Check out weights and biases. It is a great tool for logging and visualizing your results. You can also use comet.
...
project_name = "SS2023_motion_prediction"

# TODO: The stages are defined in the lit_datamodule.py file. Right now, we have a train, val, and test stage.
#  For models you dont actually train anything, like the constant velocity model, you can simply use the test stage.
...
output_size = number_of_features * future_sequence_length
hidden_size = 32
num_layers = 3
...
#  The datamodule is defined in the lit_datamodule.py file
...
mdl = MLPModel(input_size, hidden_size, output_size, num_layers)
#mdl = ConstantVelocity(sequence_length, past_sequence_length, future_sequence_length)
